...
final class SettingsRepository
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'company.email' => 'satis@bigabilisim.com',
            'company.phone' => '',
            'company.address' => '',
            'company.website' => 'https://www.antalyabigabilisim.com',
            'branding.logo_path' => '',
            'webpush.public_key' => '',
            'webpush.private_key' => '',
            'notifications.send_time' => '09:00',
            'security.challenge.enabled' => '1',
            'security.notify.enabled' => '1',
            'security.turnstile.site_key' => '',
            'security.turnstile.secret_key' => '',
            'backup.enabled' => '1',
            'backup.email' => '',
            'backup.time' => '02:00',
            'backup.keep_days' => '14',
