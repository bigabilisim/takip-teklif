...
CSS;
    ...
    public static function renderCustomerInfoRequest(array $settings, array $request, string $link): array
    {
        ...
        $body = '<!doctype html><html><head><meta charset="UTF-8"><meta name="color-scheme" content="light"></head>'
            ...
            . '<p style="margin:0 0 18px;color:#607069;font-size:15px;line-height:1.55;">' . $greeting . ' cari kartınızı doğru oluşturabilmemiz için firma bilgilerinizi güvenli form üzerinden doldurmanızı rica ederiz. İsterseniz vergi levhanızı yükleyerek alanların otomatik dolmasını sağlayabilirsiniz.</p>'
            . '<div style="margin:0 0 22px;padding:14px 16px;background:#eef6f4;border:1px solid #cae5df;border-radius:8px;color:#31413c;font-size:14px;line-height:1.55;"><strong style="display:block;margin:0 0 5px;color:#147c72;">Neden gerekli?</strong>Ürün ve hizmet yenileme bildirimlerinin doğru kişilere ulaşması, teklif ve fiyat çalışmalarının eksiksiz yapılabilmesi için firma, vergi, adres ve yetkili bilgilerinizi eksiksiz doldurmanız önemlidir.</div>'
